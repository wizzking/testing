...
<!-- //////////////////////////////////////////////////////contenido home 				-->
			...
			<div class="container section2AU">
				...
				<section class="row" style="margin-top:60px;">
					<div class="container">
						<div class="col-xs-12">
							<div class="col-xs-4">
								<img src="img/aboutUs/doña.jpg" alt="picture" class="imgAU">
								<p class="titles">Joyce Hudson</p>
								<p>Founder & Designer</p>
							</div>
							<div class="col-xs-4">
								<img src="img/aboutUs/doña2.jpg" alt="picture" class="imgAU">
								<p class="titles">Angela Campbell</p>
								<p>Project Manager</p>
							</div>
							<div class="col-xs-4">
								<img src="img/aboutUs/vato.jpg" alt="picture" class="imgAU">
								<p class="titles">James Walker</p>
								<p>Developer</p>
							</div>
						</div>
					</div>
	...
	<section>
		<img src="img/aboutUs/fverdeAU.jpg" alt="bb" class="fverdeAU">
		<div class="container">
