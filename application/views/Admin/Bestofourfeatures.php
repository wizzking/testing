...
<div class="container-fluid">
            ...
            <div class="container">
            <form id="form-create-usuario" style="padding:0px 15px;"class="form-horizontal" role="form" action="<?php base_url();?>SaveBestofourfeature" method="POST">
...
<script src="<?php echo base_url('assets/js/LoadBestAdm.js');?>"></script>
